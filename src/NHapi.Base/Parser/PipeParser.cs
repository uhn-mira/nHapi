...
public class PipeParser : ParserBase
{
    ...
    private readonly object structureDefinitionLock = new();

    private readonly ConcurrentDictionary<Type, ConcurrentDictionary<string, StructureDefinition>> structureDefinitions = new();
